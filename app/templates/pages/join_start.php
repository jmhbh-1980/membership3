<?php $v = fn (string $k) => htmlspecialchars((string) ($old[$k] ?? ''), ENT_QUOTES); ?>
...
<?php endif; ?>
<?php if (!empty($jeuneNotYetOpen)): ?>
    <div class="modal-overlay">
        <div class="modal-box">
            <h2>Inscriptions Jeune pas encore ouvertes</h2>
            <p>Les inscriptions Jeune pour la nouvelle saison ne sont pas encore ouvertes. Merci de réessayer à partir du 1er septembre.</p>
            <a href="/" class="btn">Retour au début</a>
        </div>
    </div>
<?php endif; ?>
...
<form method="post" action="/inscription" class="form form-wide" id="join-start-form">
