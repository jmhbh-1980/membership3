...
<table class="details">
    ...
    <tr><th>Paiement</th><td><?php if (!($user['subscription_paid'] ?? 0)): ?>Non réglée<?php elseif ($paidAt !== null): ?>Payé le <?= date('d/m/Y à H:i', strtotime($paidAt)) ?><?php else: ?>Réglée<?php endif; ?></td></tr>
    ...
    <tr><th>Crédits de jeu</th><td><?= htmlspecialchars(number_format((float) ($user['book_card_tickets'] ?? 0), 1, ',', ' '), ENT_QUOTES) ?></td></tr>
    <tr><th>Invitations</th><td><?= htmlspecialchars(number_format((float) ($user['book_guest_tickets'] ?? 0), 1, ',', ' '), ENT_QUOTES) ?></td></tr>
</table>
