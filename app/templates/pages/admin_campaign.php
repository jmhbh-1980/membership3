...
<form method="post" action="/admin/campagne/envoyer" class="form form-wide" style="max-width:none">
    ...
    <table class="details">
        <tr><th></th><th>Nom</th><th>Email</th><th>Abonnement</th><th>Fin</th><th>Payé</th><th>Tarif</th></tr>
        <?php foreach ($members as $m): ?>
            <tr>
                ...
                <td><?= $m['paid'] ? '✔' : '✗' ?></td>
                <?php // A link, not a nested form: this whole page is one bulk-send <form>. ?>
                <td><a href="/admin/exceptions-tarif/membre/<?= (int) $m['user_id'] ?>">Exception</a></td>
            </tr>
        <?php endforeach; ?>
    </table>
    </div>
